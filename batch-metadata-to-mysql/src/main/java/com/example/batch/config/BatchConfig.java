...
public class BatchConfig {
    ...
    public static final String FILEPATH = "src/main/resources/data/meta_Gift_Cards.json";
    public static final String DATABASE_TABLE_NAME = "meta_Gift_Cards";

//    public static final String FILEPATH = "src/main/resources/data/meta_Prime_Pantry.json";
//    public static final String DATABASE_TABLE_NAME = "meta_Prime_Pantry";
